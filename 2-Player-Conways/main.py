...
print("Welcome to Conway's 2-Player Game of Life. We start with a 10x10 grid of cells, either alive or dead. Here are the rules:\n\t Each player starts with a square. Each turn they get to pick a position to grow a cell and pick a position to kill an opponent cell. Each generation passes by following these rules:\n\t1) Any live cell with fewer than two live neighbours dies, as if by underpopulation.\n\t2) Any live cell with two or three live neighbours lives on to the next generation.\n\t3) Any live cell with more than three live neighbours dies, as if by overpopulation.\n\t4) Any dead cell with exactly three live neighbours becomes a live cell, as if by reproduction.\n")

#Building grid of size 30x60 but that can be changed
#(Pretty important to have the y-axis be 30 so that the annimation covers the entire screen on repl)
grid = []
for i in range(10):
  line = []
  for j in range(20):
...
#Setting file coordinates to be Player 1
for point in start:
